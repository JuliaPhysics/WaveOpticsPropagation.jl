...
# ╔═╡ 9d8bbf18-87b3-4ab3-8179-5019afe4fb53
using Luxor

# ╔═╡ e30e05ae-4ffa-4345-af5f-d835e4debdbf
cyl(r, ϕ) = Point(r * cos(deg2rad(ϕ)), r * sin(deg2rad(ϕ)))

# ╔═╡ cc91bb32-9995-48ad-82dd-5fa6ec232cb3
function ball(pos, α1, α2, radii=30:10:80)
	circle(pos, 20, action=:fill)
	for r in radii
		arc(pos, r, deg2rad(α1), deg2rad(α2))
		strokepath()
	end
end
